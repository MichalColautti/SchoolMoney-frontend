...
import {emptyChangePasswordErrors, validateChangePassword} from "../scripts/validate/validateChangePassword";
import {changePassword} from "../services/parent";
...
const Account = () => {
    ...
    const {data, clearData, onChangeInput} = useOnChange(emptyChangePassword);

    const {token, logout} = useAuth();

    const [errors, setErrors] = useState(emptyChangePasswordErrors);

    const fileInputRef = useRef(null);

    const handleChangePassword = async () => {
        if (!validateChangePassword(data, setErrors))
            return;
                        ...
                        <div style={styles.formContainer}>
                            ...
                            <div style={styles.inputGroup}>
                                ...
                                {errors.repeatPassword && (
                                    <span style={styles.errorText}>{errors.repeatPassword}</span>
                                )}
                            </div>
